...
export const ItemCell = memo(
  function ItemCell({ item, lane, path }: { item: Item; lane: Lane; path: number[] }) {
    ...
    const archiveOnCheck = !!lane.data.archiveOnCheck;
    const showCheckboxes = !!lane.data.showCheckboxes;
  ...
  (prev, next) => {
    return (
      prev.lane.data.archiveOnCheck === next.lane.data.archiveOnCheck &&
      prev.lane.data.showCheckboxes === next.lane.data.showCheckboxes &&
